...
def check_msg(messages):
    ...
    # Valerie's responses:
    response('Hey', ['hello', 'hi', 'sup', 'heyo', 'hey'], single_response=True)  # Response to greeting
    response('Not that great, my goldfish drowned', ['how', 'are', 'you'], required_words=['how', 'are'])  # Response to question 1
    response('You have bewitched me, body and soul from Pride and Prejudice', ['what', 'your', 'quote' 'favourite', 'movie'],
             required_words=['movie', 'quote', 'favourite'])  # Response to question 2
    response('Baby by Justin Bieber', ['what', 'your', 'current', 'favourite', 'song'],
